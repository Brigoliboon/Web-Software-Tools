...
<body class="min-h-screen flex items-center justify-center py-12 px-4">
    <div class="max-w-md w-full">
        ...
        <div class="bg-white rounded-lg shadow-lg p-8">
            <h2 class="font-display text-3xl font-bold text-center mb-6">Create Account</h2>
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="mb-6">
                    <label class="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" name="role" value="admin" class="w-5 h-5 text-primary rounded border-gray-300 focus:ring-primary">
                        <span class="text-sm text-gray-600">Register as Admin</span>
                    </label>
                    <p class="text-xs text-gray-500 mt-1">Check this to get admin access</p>
                </div>
