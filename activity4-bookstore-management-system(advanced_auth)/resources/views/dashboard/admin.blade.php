    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-3xl font-semibold text-gray-900">{{ $stats['total_books'] }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-3xl font-semibold text-gray-900">{{ $stats['total_categories'] }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
        ...
        <div class="bg-white shadow rounded-lg mb-8">
            <div class="px-4 py-5 sm:px-6">
                <h3 class="text-lg leading-6 font-medium text-gray-900">Order Status Summary</h3>
            </div>
            <div class="border-t border-gray-200">
                <div class="grid grid-cols-4 gap-4 p-4">
                    ...
                    @foreach($orderStatusSummary as $status => $count)
                        <div class="text-center p-4 rounded-lg {{ $statusColors[$status] ?? 'bg-gray-100' }}">
                            <div class="text-2xl font-bold">{{ $count }}</div>
                            <div class="text-sm uppercase">{{ $status }}</div>
                        </div>
                    @endforeach
                </div>
            </div>
