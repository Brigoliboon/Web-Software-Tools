        ...
        <div class="max-w-7xl mx-auto px-6 py-4">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-4">
                    @auth
                        <a href="{{ route('dashboard') }}" class="nav-link text-sm">Dashboard</a>
                        <a href="{{ route('orders.index') }}" class="nav-link text-sm">My Orders</a>
                        
                        <!-- Notifications Bell -->
                        <div id="notification-app" class="relative">
                            <button onclick="toggleNotifications()" class="relative p-2 rounded-full hover:bg-gray-100">
                                ...
                                <span id="notification-badge" class="absolute -top-1 -right-1 bg-red-500 text-white text-xs font-bold w-5 h-5 rounded-full flex items-center justify-center hidden">0</span>
                            </button>
                            
                            <!-- Notification Dropdown -->
                            <div id="notification-dropdown" class="absolute right-0 mt-2 w-80 bg-white rounded-lg shadow-lg py-2 z-50 hidden">
                                <div class="px-4 py-2 border-b border-gray-200 flex justify-between items-center">
                                    <span class="font-semibold text-gray-700">Notifications</span>
                                    <button onclick="markAllNotificationsRead()" id="mark-all-read-btn" class="text-xs text-indigo-600 hover:text-indigo-800 hidden">Mark all read</button>
                                </div>
